...
import (
	...
	brandrepo "monorepo/services/warehoouse/internal/modules/brand/repository"
...
func NewRepositorySQL(readDB, writeDB *gorm.DB) RepoSQL {
	...
	return &repoSQLImpl{
		...
		brandRepo: brandrepo.NewBrandRepoSQL(readDB, writeDB),
	}
}
...
func (r *repoSQLImpl) BrandRepo() brandrepo.BrandRepository {
	return r.brandRepo
}
